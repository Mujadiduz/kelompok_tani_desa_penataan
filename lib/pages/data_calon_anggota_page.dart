...
class DataCalonAnggotaPage extends StatefulWidget {
  const DataCalonAnggotaPage({super.key});

  @override
  State<DataCalonAnggotaPage> createState() => _DataCalonAnggotaPageState();
}

class _DataCalonAnggotaPageState extends State<DataCalonAnggotaPage> {
  ...
  final DatabaseReference calonRef = FirebaseDatabase.instanceFor(
    app: Firebase.app(),
    databaseURL:
  ...
  Color backgroundStatus(String status) {
    if (status == 'disetujui' || status == 'aktif') return lightGreen;
  ...
  String tanggalDaftar(Map<String, dynamic> item) {
      ...
      body: SafeArea(
        child: StreamBuilder<DatabaseEvent>(
          ...
          builder: (context, snapshot) {
            ...
            final disetujui =
                hitungStatus(semuaData, 'disetujui') +
                hitungStatus(semuaData, 'aktif');
                                ...
                                children: [
                                  ...
                                  if (semuaData.isEmpty)
                                    _emptyState(
                                      ...
                                      message:
                                          'Data calon anggota akan muncul setelah pengguna melakukan pendaftaran.',
                                    )
                                    ...
                                    _emptyState(
                                      ...
                                      message:
                                          'Tidak ada calon anggota yang sesuai dengan pencarian atau filter.',
                                    )
                                  else
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Halaman ini digunakan untuk melihat rekap seluruh calon anggota tanpa proses verifikasi.',
                style: TextStyle(
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Cari nama lengkap, NIK, alamat, atau status',
