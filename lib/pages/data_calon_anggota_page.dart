...
class _DataCalonAnggotaPageState extends State<DataCalonAnggotaPage> {
  ...
  final DatabaseReference _calonRef = FirebaseDatabase.instanceFor(
    app: Firebase.app(),
    databaseURL:
  ...
  String _jenisKelamin(Map<String, dynamic> item) {
    final raw =
        _text(
    ...
    if (raw == 'laki-laki' || raw == 'laki laki' || raw == 'pria') {
      return 'Laki-laki';
    }
          ...
          _headerInfo(
            ...
            text:
                total == 0
                    ...
                    : 'Menampilkan data calon anggota secara ringkas dan mudah dibaca.',
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Pantauan status calon anggota yang tersimpan di sistem.',
            style: TextStyle(
              color: textGrey,
              fontSize: 12.2,
              height: 1.35,
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Cari nama, NIK, alamat, atau status',
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _miniTag(Icons.wc_rounded, _jenisKelamin(item), blueStatus),
                    _miniTag(
                      Icons.event_rounded,
                      _tanggalDaftar(item),
                      orangeStatus,
