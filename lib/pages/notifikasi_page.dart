...
class _NotifikasiPageState extends State<NotifikasiPage> {
  ...
  IconData iconNotif(String tipe) {
    ...
    if (tipe == 'verifikasi_anggota') return Icons.verified_user_rounded;
  ...
  Color warnaNotif(String tipe) {
    ...
    if (tipe == 'verifikasi_anggota') return const Color(0xff1976D2);
    return primaryGreen;
  }
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                belumDibaca == 0
                    ? 'Tidak ada pemberitahuan baru terkait layanan kelompok tani.'
                    : '$belumDibaca notifikasi belum dibaca terkait status keanggotaan, bantuan pupuk, atau peminjaman alat.',
                style: TextStyle(
