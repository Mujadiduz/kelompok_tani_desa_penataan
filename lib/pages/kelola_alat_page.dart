  ...
  Future<void> simpanAlat(String? id) async {
    ...
    try {
      if (id == null) {
        ...
        await alatRef
            .child(id)
            .update({'nama_alat': namaAlat, 'jumlah_unit': jumlahUnit})
            .timeout(const Duration(seconds: 10));
      }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Masukkan nama alat dan jumlah unit yang tersedia.',
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            'Data alat ini akan dihapus dari Firebase.',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 18),
                        Expanded(child: _buildContent(snapshot, alatList)),
                      ],
                    ),
                  ),
                ),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              const Text(
                'Kelola alat pertanian milik desa untuk kebutuhan anggota kelompok tani.',
                style: TextStyle(
