...
class _DataBantuanPupukPageState extends State<DataBantuanPupukPage> {
  ...
  final DatabaseReference bantuanRef = FirebaseDatabase.instanceFor(
    app: Firebase.app(),
    databaseURL:
  ...
  String tanggalPengajuan(Map<String, dynamic> item) {
  ...
  String jumlahPupuk(Map<String, dynamic> item) {
    return '${item['jumlah_pupuk'] ?? item['jumlah'] ?? '-'} Kg';
  }
      ...
      body: SafeArea(
        child: StreamBuilder<DatabaseEvent>(
          ...
          builder: (context, snapshot) {
            ...
            final diambil = hitungStatus(semuaData, 'sudah_diambil');
                                ...
                                children: [
                                  ...
                                  if (semuaData.isEmpty)
                                    ...
                                    _emptyState(
                                      ...
                                      message:
                                          'Tidak ada data bantuan pupuk yang sesuai dengan pencarian atau filter.',
                                    )
                                  else
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Halaman ini digunakan untuk melihat rekap seluruh pengajuan bantuan pupuk tanpa proses verifikasi.',
                style: TextStyle(
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Cari nama lengkap, NIK, jenis pupuk, atau status',
